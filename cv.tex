...
Programming Languages\textsuperscript{*} \> Artificial Intelligence\textsuperscript{*} \> Number Theory\textsuperscript{*}\\
Game Theory\textsuperscript{\#} \> Cryptography\textsuperscript{\#} \> Machine Learning\textsuperscript{\#} \\ 
...
-Used frustum culling for enhanchning the game speed. \\[10pt]

\item {\large \textbf{\href{https://github.com/knsn1994/simplerisc_emulator}{Assembly Emulator} } \hspace{5.6cm} Prof. Smruti Ranjan Sarangi, 2012} \\ 
-Supports ARM assembly and SimpleRisc Assembly codes. \\ 
-Supports free flow of the code. \\
-Python's high order techniques like lambda functions, maps and filters used for programming the emulator. \\[10pt]

\item {\large \textbf{Social Network Simulation and Analysis} \hspace{3cm} Prof. Subodh Kumar, 2012}\\ 
-Multiprocessing and multithread used to achieve simulation. \\ 
-Iter process communication is eastablished by {\bf Message Queues}\\
-Final network after the simulation is stored as a graphml file. \\
-In the analysis of  the network, various queries such as shotest path, importance and clique size can be performed.
...
{\bf Basic}
& \textsc{Django Framework, Apple Script, Standard ML, BASIC, Perl}
\end{tabular*}
